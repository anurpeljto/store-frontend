...
const MobileMenu = ({isVisible}) => {  
  return (
    <div className={`sm:hidden ${isVisible ? `flex` : `hidden`} top-0 absolute flex-col pt-10 pb-5 sm:gap-20 gap-7 border-b-2 border-gray-100 right-0 bg-blackTheme w-[200px] justify-center items-center`}>
